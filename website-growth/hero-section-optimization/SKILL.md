...
description: Audit and optimize the hero section of a website to improve clarity, engagement, and conversion rates. Trigger this skill when a page has high bounce rates, low CTA click-through, or confusing messaging above the fold.
---
...
Distill the core offering into a "What's in it for me?" (WIIFM) statement for the user. Use the formula:
*Target Audience* + *Problem* + *Solution* + *Unique Benefit*.
